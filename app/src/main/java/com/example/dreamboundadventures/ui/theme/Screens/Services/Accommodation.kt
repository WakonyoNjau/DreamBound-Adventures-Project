...
fun AccommodationScreen(navController: NavHostController){
    Column {
        ...
        Card {
            ...
            Button(
                onClick = { navController.navigate(ROUTE_EXPLORE_HOTEL) }) {
            ...
            Card {
                ...
                Button(
                    onClick = { navController.navigate(ROUTE_EXPLORE_CAMP) }) {
                    Text(text = "Explore More")
                ...
                Card {
                    ...
                    Button(
                        onClick = { navController.navigate(ROUTE_EXPLORE_APARTMENT) }) {
                        Text(text = "Explore More")
